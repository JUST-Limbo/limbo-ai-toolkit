...
| [`programming-study-coach`](skills/programming-study-coach/SKILL.md) | 调研有信誉的公开课程后规划并教授编程语言，维护相互印证的教学大纲、含完整答案与验证状态的练习簿和面向学习者的知识手册，并通过官方文档导读、掌握证据、复习与跨会话交接持续推进 |

...
program2.name("tinynokeymcp").description("\u514D API Key\uFF1A\u901A\u8FC7 TinyPNG \u5B98\u7F51 Web \u540E\u53F0\u538B\u7F29 PNG/JPG").argument("<patterns...>", "\u56FE\u7247\u8DEF\u5F84\u6216 glob").option("-o, --out <dir>", "\u8F93\u51FA\u76EE\u5F55\uFF08\u9ED8\u8BA4\u8986\u76D6\u539F\u6587\u4EF6\uFF09").action(async function(patterns, opts) {
  try {
    ...
    if (opts.out) {
      await (0, import_promises2.mkdir)(opts.out, { recursive: true });
    }
    let totalSaved = 0;
